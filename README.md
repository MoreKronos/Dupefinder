...
**Note:** This project works only in conjunction with the **[Youtube-Toolbox project](https://github.com/MoreKronos/Youtube-Toolbox)**, as it relies on the folder structure and files created by that toolbox.

## Prerequisites

- Windows with PowerShell (v5+ recommended)
- The Youtube-Toolbox project set up properly
- downloads and music_files folders created by the Youtube-Toolbox
...
- Only intended for use with **[Youtube-Toolbox](https://github.com/MoreKronos/Youtube-Toolbox)** folder structure.
